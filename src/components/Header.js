      ...
      <div className="flex justify-between ">
        <div className="logo-container">
          <Link to={"/"}>
            <img
              src={LOGO_URL}
              className="ml-5 w-20 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"
            ></img>
          </Link>
        </div>
        <div className="flex items-center">
          <ul className="flex">
            ...
            <li
              className={`px-4 py-2 font-medium transition-custom ${
            ...
            <li
              className={`px-4 py-2 font-medium transition-custom ${
                isActive("/restaurants") ? "underline underline-offset-4" : ""
              }`}
            >
            ...
            <li
              className={`px-4 py-2 font-medium transition-custom ${
                isActive("/cart") ? "underline underline-offset-4" : ""
              }`}
            >
