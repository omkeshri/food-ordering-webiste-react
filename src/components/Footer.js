...
const Footer = () => {
  return (
    <div className=" pt-24 pb-4 px-36 bg-[#474747]   ">
      <div className="flex  justify-between text-white">
        <div className="w-56">
          <h1 className="font-medium text-4xl font-serif mb-5 mt-2">
            Little Cheers
          </h1>
          ...
          <div className="flex gap-2">
            ...
            <Link to={""} target="blank">
              <img
                src={facebook}
                className="w-[30px] mt-1 transition-custom"
              ></img>
            </Link>
            <Link to={""} target="blank">
        ...
        <div className=" ">
          ...
          <Link to={"/restaurants"}>
            <p className="text-sm mb-4 transition-custom">Restaurants</p>
          </Link>
          <Link to={"/contact"}>
            <p className="text-sm mb-4 transition-custom">Contact</p>
          </Link>
          <Link to={"/"}>
            <p className="text-sm mb-4 transition-custom">Cart</p>
          </Link>
        </div>
        <div className="">
      ...
      <div className="mt-20 text-center">
        <hr className="border-t-black opacity-15 mb-4"></hr>
        <p className="text-white text-xs tracking-wide">Copyright &#169; 2023 Om Keshri. All Rights Reserved</p>
      </div>
    </div>
  );
};
